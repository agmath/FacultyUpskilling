...
Here are a few reminders and some things to be on the look-out for in Chapter 4.
  ...
  + **NEW PACKAGES:** The following packages are new this week and will need to be installed prior to use: `tm`, `topicmodels`, `quanteda`, `Matrix`, <strike>`tm.plug.webmining` (you may need to [install Java](https://www.java.com/en/){target="_blank"})</strike> (see ERRORS bullet below)
