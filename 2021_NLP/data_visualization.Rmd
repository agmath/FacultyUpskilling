...
Let's create a scatterplot between `bill_length_mm` and `bill_width_mm` using the `geom_point()` layer.

```{r echo = TRUE, eval = FALSE, warning = FALSE, message = FALSE, fig.align = "center"}
penguins %>%
  ggplot() + 
  geom_point(aes(x = bill_length_mm, y = bill_width_mm))
```
